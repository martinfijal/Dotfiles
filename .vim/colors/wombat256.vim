...
call <SID>X("Normal",		"cccccc",	"3f3f3f",	"none")
...
call <SID>X("VertSplit",	"444444",	"242424",	"none")
"call <SID>X("VertSplit",	"444444",	"444444",	"none")
call <SID>X("StatusLine",	"f6f3e8",	"242424",	"italic")
"call <SID>X("StatusLine",	"f6f3e8",	"444444",	"italic")
"call <SID>X("StatusLineNC",	"857b6f",	"444444",	"none")
call <SID>X("StatusLineNC",	"857b6f",	"242424",	"none")
			"Scrollbar
			"Tooltip
			"Menu
			"WildMenu
